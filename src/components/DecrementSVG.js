...
const DecrementSVG = ({ ariaLabelledby }) => (
  <svg data-testid="decrement-SVG" xmlns="http://www.w3.org/2000/svg" width="42" height="42" aria-hidden={true} aria-labelledby={ariaLabelledby}>
